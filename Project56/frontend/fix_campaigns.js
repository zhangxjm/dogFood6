...
const content = `import { createSignal, onMount } from 'solid-js';
...
fs.writeFileSync('f:/TraeProject/dogFood6/Project56/frontend/src/pages/Campaigns.tsx', content, 'utf8');
